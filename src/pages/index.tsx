  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience hassle-free rentals with Construction Tool Rental, where individual customers can conveniently access a variety of tools from multiple outlets."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience hassle-free rentals with Construction Tool Rental, where individual customers can conveniently access a variety of tools from multiple outlets.`}
            </Text>
            <Box
