...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'order.create': {
    ...
    tenantPath: ['company', 'order'],
    userPath: [],
  },
  'order.update': {
    roles: ['owner', 'admin'],
    key: 'updated-customer-order',
    tenantPath: ['company', 'order'],
    userPath: [],
  },
  'order.delete': {
    roles: ['owner', 'admin'],
    key: 'deleted-customer-order',
    tenantPath: ['company', 'order'],
    userPath: [],
  },
  'tool.create': { roles: ['owner', 'admin'], key: 'new-tool-added', tenantPath: ['company', 'tool'], userPath: [] },
  'tool.update': { roles: ['owner', 'admin'], key: 'updated-tool-info', tenantPath: ['company', 'tool'], userPath: [] },
  'tool.delete': { roles: ['owner', 'admin'], key: 'deleted-tool', tenantPath: ['company', 'tool'], userPath: [] },
};
